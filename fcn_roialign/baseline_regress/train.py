            ...
            for phase in ['train', 'val']:
                ...
                for mini_batch, (inputs, label224, label28) in enumerate(dataloaders[phase]):
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        ...
                        dice_l = dice_loss(input=torch_pred224_prob, target=label224)
                ...
                if phase == 'train':
                    ...
                    pred28 = torch.exp(model(track_scans))  # shape of pred28 is (batch_size, 2, 28, 28)

                    pred224 = get_prob_map28(pred28)
