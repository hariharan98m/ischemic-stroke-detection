...
class Unet(nn.Module):
    ...
    def forward(self, x):
        ...
        pool5 = output['x5']  # size=(N, 512, 7, 7)
        pool4 = output['x4']  # size=(N, 512, 14, 14)
        pool3 = output['x3']  # size=(N, 256, 28, 28)
        pool2 = output['x2']  # size=(N, 128, 56, 56)
        pool1 = output['x1']  # size=(N, 64, 112, 112)
